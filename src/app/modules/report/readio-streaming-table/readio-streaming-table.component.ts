...
@Component({
  selector: 'app-readio-streaming-table',
  templateUrl: './readio-streaming-table.component.html',
  styleUrls: ['./readio-streaming-table.component.scss']
})


export class ReadioStreamingTableComponent implements OnInit, AfterViewInit {
